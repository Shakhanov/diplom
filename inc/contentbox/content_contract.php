<div class="container-fluid">
	...
	<form method="POST">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Создание договора</h1>
		</div>

		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<span>Для генерации договора, выберите шаблон (или создайте свой) , ознакомтесь с реквизитами , измените их в случае необходимости и нажмите кнопку "Сгенерировать"</span>
		</div>
			...
			<div class="col-xl-12 col-lg-12">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Параметры договра</h6>
					</div>
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-md-4 mb-3">
								<label for="contract_name">Наименование договора</label>
		...
		<!--Подключение модальных окон расчетныйх счетов-->
